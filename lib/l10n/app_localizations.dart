...
abstract class AppLocalizations {
  ...
  String errors(int count, int max) => errorsFormat
      .replaceFirst('%s', count.toString())
      .replaceFirst('%s', max.toString());
  ...
  String startLevelFormatted(int n) =>
      startLevel.replaceAll('%s', n.toString());
  String unlockedToFormatted(int n) =>
      unlockedTo.replaceFirst('%s', n.toString());
...
class _AppLocalizationsDelegate
  ...
  Future<AppLocalizations> load(Locale locale) async =>
      SynchronousFuture<AppLocalizations>(
        AppLocalizations.get(locale.languageCode),
      );
